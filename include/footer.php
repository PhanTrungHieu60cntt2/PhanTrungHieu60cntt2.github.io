	...
	<footer>
		<div class="footer-top-first">
			<div class="container py-md-5 py-sm-4 py-3">
				...
				Nếu bạn đang cân nhắc một chiếc máy tính xách tay mới, đang tìm kiếm một dàn âm thanh nổi trên xe hơi mới mạnh mẽ hoặc mua một chiếc TV HD mới, chúng tôi sẽ giúp bạn dễ dàng
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© Điện máy no xanh. All rights reserved | Design by
